---
title: Introduksjon
description: "Den 25 oktober 2016 lanserte teamet bak zeit.co et rammeverk for server-rendered React-applikasjoner, kalt Next.js. Få timer etter kunngjøringen kom idéen om å lage server-rendered Vue.js-applikasjoner på samme måte som Next.js; og Nuxt.js ble født."
---

> Den 25 oktober 2016 lanserte teamet bak [zeit.co](https://zeit.co/) et rammeverk for server-rendered React-applikasjoner, kalt [Next.js](https://zeit.co/blog/next). Få timer etter kunngjøringen kom idéen om å lage server-rendered [Vue.js](https://vuejs.org)-applikasjoner på samme måte som Next.js; og **Nuxt.js** ble født.
