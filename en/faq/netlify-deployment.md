...
Click _"Deploy site"_ to immediately trigger a deploy. Your Netlify site will be assigned a random URL, pull the contents of your repository branch, and deploy it using the `nuxt generate` command.
